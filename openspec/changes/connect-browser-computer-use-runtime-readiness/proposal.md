...
- Add an explicit Browser extension-backend feasibility spike for Desktop parity: verify whether the Browser client accepts a Forge-provided or Chrome-extension-provided backend with `type: "extension"` before treating the Browser work as parity-complete.
...
- Affected UI components: `packages/ui/src/components/right-rail.tsx`, `packages/ui/src/components/model-settings-panel.tsx`, side-panel tab components, and `packages/ui/src/ForgeApp.tsx` wiring.
